...
class Uacf7DashboardWidget {
    ...
    public function uacf7_register_dashboard_widget() {
        wp_add_dashboard_widget( 'uacf7_widget', __( 'Ultra Addons for Contact Form 7', 'ultimate-addons-for-contact-form-7' ), array( $this, 'uacf7_display_dashboard_widget' ) , null, null, 'normal', 'high' );
    }
        ...
        <div class="uacf7-widget">
            ...
            <div class="uacf7-stats">
                ...
                <?php if ( $enableDatabase ) { ?>
                    <div class="uacf7-stat">
                        ...
                        <span><?php esc_html_e( 'Total Submissions', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
                    <div class="uacf7-stat">
                        <strong>
                            <?php 
                        ...
                        <span><?php esc_html_e( 'Total Active Forms', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
                <?php }else{ ?>
                    <div class="uacf7-stat">
                        <strong>
                        ...
                        <div class="uacf7-actions">
                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=uacf7_addons' ) ); ?>" class="button">
                                <?php esc_html_e( 'Enable Database Addon To Save Entries', 'ultimate-addons-for-contact-form-7' ); ?>
                            </a>
                        </div>
                    </div>
                <?php } ?>
            ...
            <div class="uacf7-actions">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpcf7-new' ) ); ?>" class="button button-primary">
                    <?php esc_html_e( 'Create Form', 'ultimate-addons-for-contact-form-7' ); ?>
                </a>
                <?php if($enableDatabase):?>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=ultimate-addons-db' ) ); ?>" class="button">
                    <?php esc_html_e( 'View Entries', 'ultimate-addons-for-contact-form-7' ); ?>
                </a>
                <?php endif;?>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=uacf7_settings#tab=mailchimp' ) ); ?>" class="button">
                    <?php esc_html_e( 'Settings', 'ultimate-addons-for-contact-form-7' ); ?>
                </a>
            </div>

            <!-- Popular Integrations -->
            <div class="uacf7-section uacf7-integrations">
                <h4><?php esc_html_e( 'Popular Integrations', 'ultimate-addons-for-contact-form-7' ); ?></h4>
                ...
                <div class="uacf7-integration-grid">
                    ...
                    <div class="uacf7-integration-item">
                        ...
                        <span><?php esc_html_e( 'Google Sheets', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
                    ...
                    <div class="uacf7-integration-item">
                        ...
                        <span><?php esc_html_e( 'Mailchimp', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
                    ...
                    <div class="uacf7-integration-item">
                        ...
                        <span><?php esc_html_e( 'Twilio Integration', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
                    ...
                    <div class="uacf7-integration-item">
                        ...
                        <span><?php esc_html_e( 'Slack Integration', 'ultimate-addons-for-contact-form-7' ); ?></span>
                    </div>
            ...
            <div class="uacf7-actions">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=uacf7_addons' ) ); ?>" class="button">
                    <?php esc_html_e( 'Check More Integrations', 'ultimate-addons-for-contact-form-7' ); ?>
                </a>
            </div>
            ...
            <div class="uacf7-upsell">
                <h4><?php esc_html_e( 'Unlock Pro Features', 'ultimate-addons-for-contact-form-7' ); ?></h4>
                <ul>
                    <li><?php esc_html_e( '✔ Conditional Logic', 'ultimate-addons-for-contact-form-7' ); ?></li>
                    <li><?php esc_html_e( '✔ Custom Column Width', 'ultimate-addons-for-contact-form-7' ); ?></li>
                    <li><?php esc_html_e( '✔ Frontend Post Submission', 'ultimate-addons-for-contact-form-7' ); ?></li>
                    <li><?php esc_html_e( '✔ Drag & Drop File Upload & Signature', 'ultimate-addons-for-contact-form-7' ); ?></li>
                </ul>
                <a href="<?php echo esc_url( 'https://cf7addons.com/pricing' ); ?>" target="_blank" class="button button-primary go-pro">
                    <?php esc_html_e( 'Upgrade Now', 'ultimate-addons-for-contact-form-7' ); ?>
                </a>
            </div>
            <?php } ?>
            <!-- Blog Section -->
			<div class="uacf7-section-title"><?php esc_html_e( 'Latest posts from Ultra Addons for Contact Form 7', 'ultimate-addons-for-contact-form-7' ); ?></div>
			<ul class="uacf7-blog-list">
				<li>
					<span class="uacf7-badge"><?php esc_html_e( 'NEW', 'ultimate-addons-for-contact-form-7' ); ?></span>
					<a href="<?php echo esc_url( 'https://cf7addons.com/twilio-slack-integration-prevent-duplicate-entries-and-google-recaptcha-v3/' ); ?>" target="_blank"><?php esc_html_e( 'v3.5.25: Twilio, Slack integration & Security Improvements', 'ultimate-addons-for-contact-form-7' ); ?></a>
				</li>
				<li>
					<a href="<?php echo esc_url( 'https://cf7addons.com/google-recaptcha-integration-with-contact-form-7/' ); ?>" target="_blank"><?php esc_html_e( 'v3.5.21: Added Google reCAPTCHA Support', 'ultimate-addons-for-contact-form-7' ); ?></a>
				</li>
				<li>
					<a href="<?php echo esc_url( 'https://cf7addons.com/google-sheets-integration-with-contact-form-7/' ); ?>" target="_blank"><?php esc_html_e( 'v3.5.23: Google Sheets Integration with Contact form 7', 'ultimate-addons-for-contact-form-7' ); ?></a>
				</li>
			</ul>
            ...
            <div class="uacf7-footer">
                <a href="<?php echo esc_url( 'https://cf7addons.com/docs/' ); ?>" target="_blank">
                    <?php esc_html_e( 'Docs', 'ultimate-addons-for-contact-form-7' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
                <a href="<?php echo esc_url( 'https://portal.themefic.com/support/' ); ?>" target="_blank">
                    <?php esc_html_e( 'Support', 'ultimate-addons-for-contact-form-7' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
                <a href="<?php echo esc_url( 'https://cf7addons.com/blog/' ); ?>" target="_blank">
                    <?php esc_html_e( 'Blog', 'ultimate-addons-for-contact-form-7' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
